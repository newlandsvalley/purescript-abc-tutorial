...
(function(exports) {
  ...
  var ordPitchCLass = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Data.Abc line 213, column 1 - line 213, column 48: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
...
(function(exports) {
  ...
  var fromKeySet = function (ks) {
      var f = function (ka) {
          return new Data_Tuple.Tuple(ka.pitchClass, ka.accidental);
      };
      var tuples = Data_Functor.map(Data_List_Types.functorList)(function ($1) {
          return f(Data_Newtype.unwrap(Data_Abc.newtypeKeyAccidental)($1));
      })(ks);
...
(function(exports) {
  ...
  var modifyKeySet = function (newKeyA) {
      return function (ks) {
          var noMatchPC = function (pc) {
              return function (nka) {
                  return Data_Eq.notEq(Data_Abc.eqPitchCLass)(pc)((Data_Newtype.unwrap(Data_Abc.newtypeKeyAccidental)(nka)).pitchClass);
              };
          };
          if (newKeyA.accidental instanceof Data_Abc.Natural) {
              return ks;
          };
          return new Data_List_Types.Cons(newKeyA, Data_List.filter(noMatchPC(newKeyA.pitchClass))(ks));
      };
  };
  ...
  var isFlatMajorKey = function (target) {
      var v = (Data_Newtype.unwrap(Data_Abc.newtypeKeyAccidental)(target)).accidental;
      if (v instanceof Data_Abc.Natural) {
          return Data_Eq.eq(Data_Abc.eqPitchCLass)((Data_Newtype.unwrap(Data_Abc.newtypeKeyAccidental)(target)).pitchClass)(Data_Abc.F.value);
      };
      return Data_Eq.eq(Data_Abc.eqAccidental)(v)(Data_Abc.Flat.value);
  };
  ...
  var extremeSharpScale = (function () {
      var f = function (pc) {
          if (pc.pitchClass instanceof Data_Abc.F && pc.accidental instanceof Data_Abc.Natural) {
              return {
                  pitchClass: Data_Abc.E.value, 
                  accidental: Data_Abc.Sharp.value
              };
          };
          if (pc.pitchClass instanceof Data_Abc.C && pc.accidental instanceof Data_Abc.Natural) {
              return {
                  pitchClass: Data_Abc.B.value, 
                  accidental: Data_Abc.Sharp.value
              };
  ...
  var extremeFlatScale = (function () {
      var f = function (pc) {
          if (pc.pitchClass instanceof Data_Abc.E && pc.accidental instanceof Data_Abc.Natural) {
              return {
                  pitchClass: Data_Abc.F.value, 
                  accidental: Data_Abc.Flat.value
              };
          };
          if (pc.pitchClass instanceof Data_Abc.B && pc.accidental instanceof Data_Abc.Natural) {
              return {
                  pitchClass: Data_Abc.C.value, 
                  accidental: Data_Abc.Flat.value
              };
  ...
  var majorScale = function (target) {
      var chromaticScale = (function () {
          var $75 = Data_Eq.eq(Data_Abc.eqKeyAccidental)(target)({
              pitchClass: Data_Abc.G.value, 
              accidental: Data_Abc.Flat.value
          }) || Data_Eq.eq(Data_Abc.eqKeyAccidental)(target)({
              pitchClass: Data_Abc.C.value, 
              accidental: Data_Abc.Flat.value
          });
          if ($75) {
          ...
          var $76 = isFlatMajorKey(target);
          if ($76) {
              return flatScale;
          };
          var $77 = Data_Eq.eq(Data_Abc.eqKeyAccidental)(target)({
              pitchClass: Data_Abc.F.value, 
              accidental: Data_Abc.Sharp.value
          }) || Data_Eq.eq(Data_Abc.eqKeyAccidental)(target)({
              pitchClass: Data_Abc.C.value, 
  ...
  var equivalentEnharmonic = function (k) {
      if (k.pitchClass instanceof Data_Abc.A && k.accidental instanceof Data_Abc.Sharp) {
          return {
              pitchClass: Data_Abc.B.value, 
              accidental: Data_Abc.Flat.value
          };
      };
      if (k.pitchClass instanceof Data_Abc.C && k.accidental instanceof Data_Abc.Sharp) {
          return {
              pitchClass: Data_Abc.D.value, 
              accidental: Data_Abc.Flat.value
          };
      };
      if (k.pitchClass instanceof Data_Abc.D && k.accidental instanceof Data_Abc.Sharp) {
          return {
              pitchClass: Data_Abc.E.value, 
              accidental: Data_Abc.Flat.value
          };
      };
      if (k.pitchClass instanceof Data_Abc.G && k.accidental instanceof Data_Abc.Sharp) {
          return {
              pitchClass: Data_Abc.A.value, 
              accidental: Data_Abc.Flat.value
          };
  ...
  var accidentalKey = function (ka) {
      return Data_Eq.notEq(Data_Abc.eqAccidental)((Data_Newtype.unwrap(Data_Abc.newtypeKeyAccidental)(ka)).accidental)(Data_Abc.Natural.value);
  };
  ...
  var modifiedKeySet = function (ksm) {
      ...
      var $118 = Data_List["null"](ksm.modifications);
      if ($118) {
          return kSet;
      };
...
(function(exports) {
  ...
  var Recording = function (x) {
      return x;
  };
  var newtypeTrack = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Track);
  var newtypeRecording = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Recording);
  var newtypeHeader = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Header);
  exports["Tempo"] = Tempo;
  ...
  exports["newtypeHeader"] = newtypeHeader;
  exports["newtypeRecording"] = newtypeRecording;
...
(function(exports) {
              ...
              return function (abcNote) {
                  ...
                  if (tstate.lastNoteTied instanceof Data_Maybe.Just) {
                      var combinedAbcNote = (function () {
                          var $42 = {};
                          for (var $43 in abcNote) {
                              if ({}.hasOwnProperty.call(abcNote, $43)) {
                                  $42[$43] = abcNote[$43];
                              };
                          };
                          $42.duration = Data_Semiring.add(Data_Rational.semiringRational)(abcNote.duration)(tstate.lastNoteTied.value0.duration);
                          return $42;
                      })();
                      if (abcNote.tied) {
  ...
  var coalesceBar = function (tstate) {
      return function (abcBar) {
          ...
          var bar$prime = (function () {
              var $56 = {};
              for (var $57 in tstate.currentBar) {
                  if ({}.hasOwnProperty.call(tstate.currentBar, $57)) {
                      $56[$57] = tstate["currentBar"][$57];
                  };
              };
              $56.repeat = newRepeat;
              $56.iteration = abcBar.iteration;
              return $56;
          })();
          var $59 = {};
          for (var $60 in tstate) {
              if ({}.hasOwnProperty.call(tstate, $60)) {
                  $59[$60] = tstate[$60];
              };
          };
          $59.currentBar = bar$prime;
          return $59;
      };
  };
  ...
  var addUnitNoteLenToState = function (tstate) {
      return function (d) {
          var abcTempo$prime = (function () {
              var $63 = {};
              for (var $64 in tstate.abcTempo) {
                  if ({}.hasOwnProperty.call(tstate.abcTempo, $64)) {
                      $63[$64] = tstate["abcTempo"][$64];
                  };
              };
              $63.unitNoteLength = d;
              return $63;
          ...
          var bar$prime = (function () {
              var $66 = {};
              for (var $67 in tstate.currentBar) {
                  if ({}.hasOwnProperty.call(tstate.currentBar, $67)) {
                      $66[$67] = tstate["currentBar"][$67];
                  };
              };
              $66.midiMessages = new Data_List_Types.Cons(tempoMsg, tstate.currentBar.midiMessages);
              return $66;
          })();
          var $69 = {};
          for (var $70 in tstate) {
              if ({}.hasOwnProperty.call(tstate, $70)) {
                  $69[$70] = tstate[$70];
              };
          };
          $69.abcTempo = abcTempo$prime;
          $69.currentBar = bar$prime;
          return $69;
      };
  };
  var addTempoToState = function (tstate) {
      return function (tempoSig) {
          var abcTempo$prime = (function () {
              var $72 = {};
              for (var $73 in tstate.abcTempo) {
                  if ({}.hasOwnProperty.call(tstate.abcTempo, $73)) {
                      $72[$73] = tstate["abcTempo"][$73];
                  };
              };
              $72.tempoNoteLength = Data_Foldable.foldl(Data_List_Types.foldableList)(Data_Semiring.add(Data_Rational.semiringRational))(Data_Rational.fromInt(0))(tempoSig.noteLengths);
              $72.bpm = tempoSig.bpm;
              return $72;
          })();
          var tempoMsg = midiTempoMsg(abcTempo$prime);
          var bar$prime = (function () {
              var $75 = {};
              for (var $76 in tstate.currentBar) {
                  if ({}.hasOwnProperty.call(tstate.currentBar, $76)) {
                      $75[$76] = tstate["currentBar"][$76];
                  };
              };
              $75.midiMessages = new Data_List_Types.Cons(tempoMsg, tstate.currentBar.midiMessages);
              return $75;
          })();
          var $78 = {};
          for (var $79 in tstate) {
              if ({}.hasOwnProperty.call(tstate, $79)) {
                  $78[$79] = tstate[$79];
              };
          };
          $78.abcTempo = abcTempo$prime;
          $78.currentBar = bar$prime;
          return $78;
      };
  };
  var addRestToState = function (tstate) {
      return function (duration) {
          ...
          var bar$prime = (function () {
              var $81 = {};
              for (var $82 in tstate.currentBar) {
                  if ({}.hasOwnProperty.call(tstate.currentBar, $82)) {
                      $81[$82] = tstate["currentBar"][$82];
                  };
              };
              $81.midiMessages = new Data_List_Types.Cons(msg, tstate.currentBar.midiMessages);
              return $81;
          })();
          var $84 = {};
          for (var $85 in tstate) {
              if ({}.hasOwnProperty.call(tstate, $85)) {
                  $84[$85] = tstate[$85];
              };
          };
          $84.currentBar = bar$prime;
          return $84;
      };
  };
      ...
      return function (tempoModifier) {
          return function (tstate) {
              return function (abcNote) {
                  ...
                  var $93 = {};
                  for (var $94 in tstate) {
                      if ({}.hasOwnProperty.call(tstate, $94)) {
                          $93[$94] = tstate[$94];
                      };
                  };
                  $93.currentBar = (function () {
                      var $90 = {};
                      for (var $91 in tstate.currentBar) {
                          if ({}.hasOwnProperty.call(tstate.currentBar, $91)) {
                              $90[$91] = tstate["currentBar"][$91];
                          };
                      };
                      $90.midiMessages = v.value0;
                      return $90;
                  })();
                  $93.lastNoteTied = v.value1;
                  $93.currentBarAccidentals = barAccidentals;
                  return $93;
              };
          };
      };
  ...
  var addNoteOffToState = function (duration) {
      return function (tstate) {
          return function (abcNote) {
              ...
              var bar$prime = (function () {
                  var $98 = {};
                  for (var $99 in tstate.currentBar) {
                      if ({}.hasOwnProperty.call(tstate.currentBar, $99)) {
                          $98[$99] = tstate["currentBar"][$99];
                      };
                  };
                  $98.midiMessages = new Data_List_Types.Cons(msg, tstate.currentBar.midiMessages);
                  return $98;
              })();
              var $101 = {};
              for (var $102 in tstate) {
                  if ({}.hasOwnProperty.call(tstate, $102)) {
                      $101[$102] = tstate[$102];
                  };
              };
              $101.currentBar = bar$prime;
              return $101;
          };
      };
  };
  ...
  var addKeySigToState = function (tstate) {
      return function (mks) {
          var $104 = {};
          for (var $105 in tstate) {
              if ({}.hasOwnProperty.call(tstate, $105)) {
                  $104[$105] = tstate[$105];
              };
          };
          $104.modifiedKeySignature = mks;
          return $104;
      };
  };
  ...
  var addBarToState = function (tstate) {
      return function (bar) {
          var $112 = isBarEmpty(tstate.currentBar);
          if ($112) {
          ...
          $113.currentBar = buildNewBar(tstate.currentBar.number + 1 | 0)(bar);
          $113.currentBarAccidentals = Data_Abc_Accidentals.empty;
          $113.repeatState = repeatState;
          $113.rawTrack = rawTrack;
          return $113;
      };
  };
  var transformMusic = function (m) {
      ...
      if (m instanceof Data_Abc.Rest) {
          return updateState(addRestToState)(m.value0);
      };
      if (m instanceof Data_Abc.Tuplet) {
          return updateState(addNotesToState(false)(Data_Rational.rational(m.value0.q)(m.value0.p)))(m.value1);
      };
      ...
      if (m instanceof Data_Abc.BrokenRhythmPair) {
          ...
          throw new Error("Failed pattern match at Data.Abc.Midi line 180, column 7 - line 188, column 75: " + [ m.value1.constructor.name ]);
      };
  ...
  var transformMusicLine = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Abc.Midi line 135, column 1 - line 138, column 19: " + [ v.constructor.name ]);
  };
  var transformBodyPart = function (bodyPart) {
      ...
      throw new Error("Failed pattern match at Data.Abc.Midi line 128, column 3 - line 132, column 29: " + [ bodyPart.constructor.name ]);
  };
  ...
  var buildRepeatedMelody = function (mbs) {
      return function (sections) {
          var $164 = Data_List["null"](sections);
          if ($164) {
              return Data_List_Types.Nil.value;
          };
  ...
  var finaliseMelody = Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity)))(function (v) {
      ...
      var tstate$prime = (function () {
          var $166 = {};
          for (var $167 in tstate) {
              if ({}.hasOwnProperty.call(tstate, $167)) {
                  $166[$167] = tstate[$167];
              };
          };
          $166.rawTrack = new Data_List_Types.Cons(tstate.currentBar, tstate.rawTrack);
          $166.repeatState = repeatState;
          return $166;
      })();
      var track = buildRepeatedMelody(tstate$prime.rawTrack)(tstate$prime.repeatState.sections);
      var recording$prime = (function () {
          var v1 = Data_Newtype.unwrap(Data_Midi.newtypeRecording)(recording);
          var $169 = {};
          for (var $170 in v1) {
          ...
          $169.tracks = Data_List.singleton(track);
          return $169;
      })();
  ...
  var transformBody = function (v) {
      ...
      throw new Error("Failed pattern match at Data.Abc.Midi line 118, column 1 - line 120, column 19: " + [ v.constructor.name ]);
  };
...
(function(exports) {
              ...
              return function (endOffset) {
                  return function (tstate) {
                      ...
                      if (mpnote instanceof Data_Maybe.Just) {
                          ...
                          var $17 = endOffset - tstate.phraseOffset > phraseSize && Data_Map.isEmpty(currentNoteMap);
                          if ($17) {
                              var $18 = {};
                              for (var $19 in tstate) {
                                  if ({}.hasOwnProperty.call(tstate, $19)) {
                                      $18[$19] = tstate[$19];
                                  };
                              };
                              $18.currentNoteMap = currentNoteMap;
                              $18.noteOffset = endOffset;
                              $18.phraseOffset = endOffset;
                              $18.currentPhrase = [  ];
                              $18.melody = Data_Array.cons(Data_Array.reverse(currentPhrase))(tstate.melody);
                              return $18;
                          };
                          var $21 = {};
                          for (var $22 in tstate) {
                              if ({}.hasOwnProperty.call(tstate, $22)) {
                                  $21[$22] = tstate[$22];
                              };
                          };
                          $21.currentNoteMap = currentNoteMap;
                          $21.noteOffset = endOffset;
                          $21.currentPhrase = currentPhrase;
                          return $21;
                      };
                      var $25 = {};
                      for (var $26 in tstate) {
                          if ({}.hasOwnProperty.call(tstate, $26)) {
                              $25[$26] = tstate[$26];
                          };
                      };
                      $25.noteOffset = endOffset;
                      return $25;
                  };
              };
          };
  ...
  var buildPartialNote = function (pitch) {
      return function (velocity) {
      ...
      return function (pitch) {
          return function (velocity) {
              return function (offset) {
                  return function (tstate) {
                      var partialNote = buildPartialNote(pitch)(velocity)(offset);
                      var key = noteKey(channel)(pitch);
                      var currentNoteMap = Data_Map.insert(Data_Ord.ordInt)(key)(partialNote)(tstate.currentNoteMap);
                      var $28 = {};
                      for (var $29 in tstate) {
                          if ({}.hasOwnProperty.call(tstate, $29)) {
                              $28[$29] = tstate[$29];
                          };
                      };
                      $28.noteOffset = partialNote.timeOffset;
                      $28.currentNoteMap = currentNoteMap;
                      return $28;
                  };
              };
          };
  ...
  var accumulateTicks = function (ticks) {
      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity)))(function (v) {
          ...
          var tstate$prime = (function () {
              var $32 = {};
              for (var $33 in tstate) {
                  if ({}.hasOwnProperty.call(tstate, $33)) {
                      $32[$33] = tstate[$33];
                  };
              };
              $32.noteOffset = offset;
              return $32;
          })();
          var tpl$prime = new Data_Tuple.Tuple(tstate$prime, recording);
          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(tpl$prime))(function (v1) {
  ...
  var accumulateTempo = function (ticks) {
      return function (tempo) {
          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity)))(function (v) {
              ...
              var tstate$prime = (function () {
                  var $36 = {};
                  for (var $37 in tstate) {
                      if ({}.hasOwnProperty.call(tstate, $37)) {
                          $36[$37] = tstate[$37];
                      };
                  };
                  $36.noteOffset = offset;
                  $36.tempo = tempo;
                  return $36;
              })();
              var tpl$prime = new Data_Tuple.Tuple(tstate$prime, recording);
  ...
  var toPerformance = function (recording) {
      var mtrack0 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_Newtype.unwrap(Data_Midi.newtypeTrack))(Data_List.head((Data_Newtype.unwrap(Data_Midi.newtypeRecording)(recording)).tracks));
      var track0 = Data_Maybe.fromMaybe(Data_List_Types.Nil.value)(mtrack0);
      var header = Data_Newtype.unwrap(Data_Midi.newtypeHeader)((Data_Newtype.unwrap(Data_Midi.newtypeRecording)(recording)).header);
      return Control_Monad_State.evalState(transformTrack(track0))(initialTransformationState(header.ticksPerBeat));
  };
...
(function(exports) {
  ...
  var setMidiRecording = function (recording) {
      return function (state) {
          ...
          $12.melodySource = new MIDI(recording);
          $12.melody = [  ];
          return $12;
      };
  };
  var setAbcTune = function (abcTune) {
      return function (state) {
          ...
          $15.melodySource = new ABC(abcTune);
          $15.melody = [  ];
          return $15;
      };
  };
  ...
  var locateNextPhrase = function (state) {
      var $18 = !state.playing || Data_Array["null"](state.melody);
      if ($18) {
          return Data_Maybe.Nothing.value;
      };
      ...
      return function (sDelay) {
          ...
          if (v instanceof Data_Maybe.Just) {
              var newState = (function () {
                  ...
                  $20.phraseIndex = state.phraseIndex + 1 | 0;
                  return $20;
              })();
  ...
  var establishMelody = function (playing) {
      return function (state) {
          var $25 = Data_Array["null"](state.melody);
          if ($25) {
              ...
              throw new Error("Failed pattern match at Data.Midi.Player line 88, column 5 - line 102, column 14: " + [ state.melodySource.constructor.name ]);
          };
          var $35 = {};
          for (var $36 in state) {
  ...
  var foldp = function (v) {
      return function (state) {
          ...
          if (v instanceof PlayMelody) {
              var $43 = v.value0 && state.phraseIndex === 0;
              if ($43) {
          ...
          if (v instanceof StopMelody) {
              return Pux.noEffects((function () {
                  var $48 = {};
                  for (var $49 in state) {
                      if ({}.hasOwnProperty.call(state, $49)) {
                          $48[$49] = state[$49];
                      };
                  };
                  $48.phraseIndex = 0;
          ...
          throw new Error("Failed pattern match at Data.Midi.Player line 108, column 1 - line 108, column 38: " + [ v.constructor.name, state.constructor.name ]);
      };
  };                                                                                             
...
(function(exports) {
  ...
  var Data_Semigroup = PS["Data.Semigroup"];
  var Prelude = PS["Prelude"];        
  var xmplUnitNote = "L: 1/16 \x0d\x0aA B c def";
  var xmplTriplet = "K:Dmaj\x0d\x0a| A2 | d2 e>f (3g2f2d2 | B4 |";
  var xmplTitle = "X:1\x0d\x0aT:Camptown Races\x0d\x0aM:4/4\x0d\x0aL:1/8\x0d\x0aK:D\x0d\x0a|AAFA|BAF2|FE2z|FE2z|AAFA|BAF2|E2FE|D2-D2|\x0d\x0a|D>DFA|d4|B>BdB|A3F|\x0d\x0aAA F/2F/2 A/2A/2|BAF2|EF/2-G/2FE|D4 |\x0d\x0a";
  var xmplTie = "| G2 | c2c2 A2Ac | B2B2- B2AB |";
  var xmplTempo = "L: 1/8 \x0d\x0aQ: 1/4=60\x0d\x0aA B c def";
  var xmplStrathspey = "| G | c2 e>c G<c e>g |\x0d\x0a| c'2 b>c' a<c' g>e |";
  var xmplRhythm = "X: 1\x0d\x0aT: Kapten Lindholms Engelska\x0d\x0aR: engelska\x0d\x0aM: 4/4\x0d\x0aL: 1/8\x0d\x0aK:Amaj\x0d\x0a" + ("|: ed | cAce dcdf | ecAF E2 ed |\x0d\x0a| cABc defg | aece agfe | cAce dcdf |\x0d\x0a| ecAF E2 ed | cABc defg | a2 ag a2 :|\x0d\x0a" + "|: e2 | aac'e aac'e | bbd'e bbd'e | aac'e aac'e |\x0d\x0a| efed cB A2| fdfa ecea | fdfa ecea |\x0d\x0a| fdfa gegb | baag a2 :|\x0d\x0a");
  var xmplRests = "| c2 c2 z cBA |\x0d\x0a" + "| E2 A2 z3 A |";
  var xmplRepeatVariants = "L: 1/16\x0d\x0aK:Dmaj\x0d\x0a|: A4 a4 a2f2 | gfga b3a g2f2 |\x0d\x0a| e3f g2b2 a2g2 | f3e d2c2 d2B2 |\x0d\x0a" + "|1 B2A^G A8 :|2 B2AG F2EF A2A,2 | A,2D2 D8 |";
  var xmplRepeat = "| C2 D2 E2 C2 :|: E2 F2 G4 :|\x0d\x0a|: GAGF E2 C2 :|: C2 G,2 C4 :|";
  var xmplQuadruplet = "K:Amaj\x0d\x0a| (3efg a2 a>b | (3agf e2-e>e |\x0d\x0a| (4f2d2e2c2 | d>f (3f2e2c2 |";
  var xmplOctaves = "| C,, G,, C, G, | C G c g | c' g' c''4 |";
  var xmplNotes = "A B c def";
  var xmplNaturals = "K: AMajor \x0d\x0a| A2 B=c dcBc [CEA] |";
  var xmplMixolydian = "X: 1\x0d\x0aT: The Yellow Wattle\x0d\x0aR: jig\x0d\x0aM: 6/8\x0d\x0aL: 1/8\x0d\x0aK: Dmix\x0d\x0a" + ("|:dcA AGE|ABA ABc|dcA ABc|dcA AGE|\x0d\x0a" + ("dcA AGE|ABA AGE|EDD cde|dcA GED:|\x0d\x0a" + ("|:DED c3|ded c3|DED cde|dcA GED|\x0d\x0a" + "DED c3|ded d2c|ABA ABc|dcA GED:|\x0d\x0a")));
  var xmplMeter = "Q:3/8=120\x0d\x0aM:9/8\x0d\x0aK:D\x0d\x0a" + ("ABA A2G F2G | ABA AGF G2E |\x0d\x0a" + ("ABA A2G F2G | A2d d2c d3 |\x0d\x0a" + ("A2g f2d e2c | A2B =c2B c2B |\x0d\x0a" + ("A2g f2d e2^c | A2d d2c d3 |\x0d\x0a" + ("A2g f2d e2c | A2B =c2B c2^c |\x0d\x0a" + "d2A A2G F2G | A2d d2c d3 |\x0d\x0a")))));
  var xmplLongNotesAndBars = "| c2 cG c2 e2 | g4";
  var xmplKlezmer = "X: 1\x0d\x0aT: Der Badchen Freylach \x0d\x0aM: 2/4\x0d\x0aL: 1/16\x0d\x0aK: Ddor^G\x0d\x0a" + ("|: DA,DF GAGF | A2A2 FED2 | DA,DF GAGF | A4 A4- |\x0d\x0a" + ("| AA,DF GAFD | A2A2 FED2 | EFGF EDEF | D8 :|\x0d\x0a" + ("|: ABcB dcBA | GABc A4 | dcBA GABc | A4 A4 |\x0d\x0a" + ("| ABcB dcBA | GABc A4 |1 ABcB AB (3FED | EFD2- D4 |\x0d\x0a" + ":|2 GABA GAFE | D8 :||\x0d\x0a"))));
  var xmplKeySig = "K: AMajor \x0d\x0a| [acE]3 B A2G2 | [eBGE]4 |";
  var xmplInformation = "X: 1\x0d\x0aT: Gubbdansen\x0d\x0aS: from 12 la\u030atar fo\u0308r 2 eller 3 fioler med Ga\u0308rdebyla\u030aten i Hjort Anders Olssons originalsa\u0308ttning\x0d\x0a" + ("Z: John Batchellor\x0d\x0aR: polska\x0d\x0aM: 3/4\x0d\x0aL: 1/16\x0d\x0aK:Dmin\x0d\x0a" + ("|: f3g f4 a4 | a2ba g2ag f2e2 | d3e f2g2 a2f2 | f3e e2^c2 A4 :|\x0d\x0a" + ("|: ^c2c2 d2d2 e2e2 | f2f2 gfed e4 | ^c2c2 d2d2 e2e2 | f2f2 gfed e4 |\x0d\x0a" + "a4 b2a2 g2f2 | f2ef g2f2 e2d2 | fed^c c4 d4 :|\x0d\x0a")));
  var xmplHornpipe = "| C>GE>G C>GE>G |\x0d\x0a| c>de>d c>BA>G |";
  var xmplFractionalNotes = "| C3/2G1/2 E3/2G1/2 C3/2G/ E3/2G/ |";
  var xmplFlatKeySig = "K: Bb\x0d\x0a| BfdB AecA | FdBF D4 |";
  var xmplComplexTriplet = "K:Gmaj\x0d\x0a| D2 G>A B>c| (3:2:4d2d2Bd g2|";
  var xmplChords = "| [acE]3 B A2G2 | [eBGE]4 |";
  var xmplChangeKeyTransient = "X:1\x0d\x0aQ:1/4=80\x0d\x0aM:2/4\x0d\x0aK:C\x0d\x0a| C,E,G,C |[K:A] A,CEA |\x0d\x0a|[K:B] B,DFB |[K:C] CEGc |\x0d\x0a";
  var xmplChangeKey = "T:Polska fr\xe5n Sm\xe5land \x0d\x0aM:3/4\x0d\x0aL:1/16\x0d\x0aR:polska\x0d\x0aK:Bmin\x0d\x0a" + ("|: B4 A4 B4 | d2f2 e2dc c2d2 | B2B2 A2A2 B2B2 |d2f2 e2dc d4 |\x0d\x0a" + ("F2GA B2AB c2Bc |d2cd edcB A2F2 | F2GA B2AB c2Bc |d2cd edcB A2F2 |\x0d\x0a" + ("F2GA B2c2 d3B | B2A2 B8 :|\x0d\x0a" + ("K:F#Min\x0d\x0a" + ("|: f4 e4 f4 |g2a2 b2ag g2a2 |f2f2 e2e2 f2f2 |g2a2 b2ag a4 |\x0d\x0a" + ("c2de f2ef g2fg |a2ga bagf e2c2 | c2de f2ef g2fg |a2ga bagf e2c2 |\x0d\x0a" + "c2de f2g2 a3f |f2e2 f8 :|\x0d\x0a"))))));
  var xmplBalkan = "X: 1\x0d\x0aT: Acano mlada nevesto\x0d\x0aO: Macedonia\x0d\x0aS: R.B.Iverson\x0d\x0aM: 11/16\x0d\x0aL: 1/16\x0d\x0aK: AMin^G\x0d\x0a" + ("|: E3  e2e2 d2c2 | ~B2A ~A2GA B2-B2 :: A2A dccB BAAG |\x0d\x0a" + ("| G2F ~F2EF ~G2FE | A2A dccB BAAG | ~G2F ~FGFE E2E2 :|\x0d\x0a" + ("|: EFD EFGA BcBA | Bcd cBcA BEeE |\x0d\x0a" + "|  EFD EFGA BcBA | GAB AGFE E2-E2 :|\x0d\x0a")));
  var xmplAccidentals = "K: AMinor \x0d\x0a| A2 B^c dcBc [CEA] |";
  var instUnitNote = "You may have noticed when we first introduced notes that we talked about their duration in 'units'.  But how long is a unit?" + (" So far, we have used, by default, a convention that it represents an eighth note (a quaver)." + (" We can change the unit to be a sixteenth note (a semiquaver) if we use the L (unit note length) header." + " This will have the effect of doubling the speed."));
  var instTriplet = "A triplet is usually used if you want to play three notes in the time normally taken by two." + (" You introduce three notes of the same length placed together with the symbol (3" + " This is extremely common in Swedish polskas - for example the start of the Grind Hans J\xe4ssp\xf4dspolska.");
  var instTitle = "Very many of our previous examples have had no headers - only the melody line.  But, in fact a legitimate ABC tune always" + (" requires some headers.  The first is largely irrelevant - a reference number denoted by X.  Any number will do" + (" in most cases. The second header must be the tune title - T. You should also include the L (note length) and  M (meter) headers" + " introduced earlier. Finally, the K (key) header should always be the last one."));
  var instTie = "A tie joins together two notes of the same pitch.  It is indicated by placing a hyphen directly after the first note of the pair." + (" The second note may follow immediately, but it can be separated by spaces or even a bar line.  The effect is to play one long note" + " with the combined duration of the pair.  If the notes are of different pitches, the tie will simply be ignored.");
  var instTempo = "An accurate tempo is defined by means of the Q (tempo) header.  Up till now, we've used a default where we have 120 quarter notes per minute" + (" i.e 1/4=120.  We can, for example, slow down our tune firstly by reverting to a unit note length of 1/8 and secondly by explicitly reducing the " + " tempo with the Q header.");
  var instStrathspey = "Conversely, you can shorten the first note of a pair and lengthen the second by means of the < character." + " This rhythm is found in strathspeys.";
  var instRhythm = "You can use the R (rhythm) header to indicate the type of tune (jig, reel, polska etc.). In most ABC collections, this field is optional." + (" However, if you want to save your tune to tradtunedb, it requires a rhythm header to be present so that you can search" + " easily for tunes of the same type");
  var instRests = "Use the character z to represent a rest.  In exactly the same manner as for notes, you can set the length of a rest by adding a number after it." + (" For example z3 will make the rest last for three units." + " You can spread out the tune into multiple lines if you like by hitting carriage return.");
  ...
  var instRepeat = "You can indicate that a section should be repeated by sandwiching it between bars which use the colon as a repeat marker - |: and :|" + " The initial repeat marker at the first bar is optional.";
  var instQuadruplet = "Quadruplets are used if you want to play four notes in the time usually taken by three." + (" In a similar fashion to triplets, introduce four notes of the same length placed together" + " with the symbol (4. This example contains triplets, a tie and a quadruplet.");
  var instOctaves = "You can reach the octave below middle C by adding a comma immediately after the note name." + (" Each time you add a comma, you drop a further octave. " + (" Similarly higher octaves can be reached using apostrophes." + " If you want a longer note, you must put the duration after the comma or apostrophe."));
  var instNotes = "Use the upper-case characters A-G for the notes of the octave starting from middle C and lower-case a-g for the octave above that." + (" In this example, each note has the same length - let's call it the 'unit length' for the moment." + (" You can place notes next to each other or separate them with spaces - it won't make much difference to" + " the sound. However, in a score, if they're adjacent then notes with tails will have them joined together."));
  var instNaturals = "If your key means that certain notes are sharpened or flattened, but you need to play the 'natural' " + (" (unsharpened or unflattened) note, then you can override the key by using an equals symbol immediately before the note." + (" Remember that, as in a score, you only need to mark as natural the first occurrence of the note in any given bar." + " For example, this reintroduces the minor feel although the key is still a major one. Each C in the bar is natural."));
  var instMixolydian = "If you come across a modal tune, rather than marking its key signature as straightforward major or minor," + (" you can instead use the mode name. For example, the following tune is in D Mixolydian.  But remember, the classical" + (" modes all use the standard diatonic scale - they just start at different places along the scale. So for this tune " + " the printed score would look, to all intents and purposes, identical to that for E Minor. Feel free to use either signature."));
  var instMeter = "The meter is defined with the M header.  For example, a waltz would normally have the meter 3/4 and a march 4/4." + (" 3/4 means that each complete bar should have a total duration equal to that of three quarter notes." + (" The presence of a meter actually makes little difference to how the tune sounds, but will show up in a score." + (" But it is important to make sure that the duration of each complete bar agrees with the meter you designate." + " This example is a slip-jig in 9/8.")));
  var instLongNotesAndBars = "You can make a note last longer by putting a number after the note name." + (" So, for example, c2 represents the note C in the octave immediately above the one that starts with middle C, having a duration of two units." + " Use a vertical bar to introduce a bar line.");
  var instKlezmer = "Klezmer tends to use modes that are not diatonic scales - some intervals are more than two semitones." + (" Suppose you have a tune that would be in a 'standard' mode except that one note in the scale is sharpened." + (" You can either use the name of the mode in the key signature and then explicitly sharpen this note each time it occurs in the score" + (" or you can modify the key signature itself, adding as many (sharpened or flattened) accidentals as are needed." + " The following tune is in D Dorian, but with every G sharpened.")));
  var instKeySig = "ABC lets you add information that determines how the tune is to be played." + (" So far, we have only used the white notes on the piano - i.e. the tune snippets have tended to be in the keys of either" + (" C Major or A Minor.  If we want tunes in a different key, we can add what's called a 'K header' where K represents the key signature. " + (" A header is usually placed on a line of its own before the melody starts." + " In the key of A, every C, F and G in the melody is implicitly sharpened - this will give a 'major' feel to the chord example.")));
  var instInformation = "There are various other headers that you can use to add information about the tune as free text.  The most important are these: " + " C (composer), O (geographical origin), S (source - where or how the tune was collected) and Z (the tune transcriber).";
  var instHornpipe = "The last example was in a hornpipe-like rhythm.  Because this is so common, there is a shorthand for it" + (" where you separate each pair of notes with the > character.  This extends the first note by half its length" + " and reduces the second by the same amount.");
  var instFractionalNotes = "You can shorten a note by placing a fraction after the note.  This could be, for example," + (" 1/2 or 1/3. A shorthand for 1/2 is simply / and a shorthand for 1/3 is simply /3." + (" You can also have longer notes if you use a fraction greater than 1.  Rests are treated the same way." + " If you make notes too short, they may not be heard."));
  var instFlatKeySig = "If your key is a major key, you can, if you want, leave out the word 'Major'.  If it is a flat key, you use 'b' and if a sharp key, '#'. " + " You can also choose to shorten the mode name to just three letters - i.e. BbMaj, BbMajor and Bb are equivalent to each other.";
  var instComplexTriplet = "If your triplet has notes of different lengths, you have to use the complex triplet notation." + (" For example (3:2:4d2d2Bd means play the rhythm of three notes in the time of two over the following group" + " of four notes.");
  var instChords = "You can play a chord by placing a group of notes, adjacent to each other, inside square brackets - for example [acE]." + (" To set the duration of the chord, you can either set the length of each note individually or else for the entire chord." + " If you do both, the durations are multiplied together");
  var instChangeKeyTransient = "You can also mark a transient key change by placing the K (key) header in the body of the tune score, but enclosed within square brackets.";
  var instChangeKey = "If a tune changes key, you can indicate this simply by placing the K (key) header inside the score at the point where the key changes." + (" In this example, the first part of the tune is in B Minor and the second part in F# Minor." + " Various other headers can be used within the score in this way - in particular, the M (meter) and L (unit note length) headers.");
  var instBalkan = "Balkan music also tends to have unusual modes and time signatures.  This tune is in A Minor with a sharpened G; the meter is 11/16." + " The '~' symbol indicates a particular decoration - a roll - but this player does not attempt it.";
  var instAccidentals = "Similarly, you can sharpen a note by placing a caret symbol (^) immediately before it and flatten it using an underscore" + (" symbol (_). If you need a double sharp or double flat, then just double the appropriate symbol." + " This example brings back the major feel although the key is now A Minor. Each C is sharpened.");
  var hintRests = "Try adding another bar which contains both notes and rests.";
  var hintOctaves = "Experiment by adding some more high or low notes.";
  var hintNotes = "Try altering some of the notes.";
  var hintLongNotesAndBars = "Try experimenting with different note lengths.";
  var hintHornpipe = "If you know it, can you finish off the 'A' part of the tune?";
  var hintFractionalNotes = "Try experimenting with a succession of notes of different pitch and with different fractional values.";
  var hintChords = "Try adding another phrase that ends in a chord.";
  var lessons = [ {
      id: "notes", 
      title: "the notes", 
      ...
      id: "longnotesandbars", 
      title: "long notes and bars", 
      instruction: instLongNotesAndBars, 
      example: xmplLongNotesAndBars, 
      hint: hintLongNotesAndBars
  }, {
      id: "rests", 
      title: "rests", 
      instruction: instRests, 
      example: xmplRests, 
      hint: hintRests
  }, {
      id: "octaves", 
      ...
      instruction: instFractionalNotes, 
      example: xmplFractionalNotes, 
      hint: hintFractionalNotes
  }, {
      id: "hornpipes", 
      title: "hornpipes", 
      ...
      id: "keychangetransient", 
      title: "transient key changes", 
      instruction: instChangeKeyTransient, 
      example: xmplChangeKeyTransient, 
      hint: ""
  }, {
      id: "modes", 
      title: "other modes", 
  ...
  var last = Data_Array.length(lessons) - 1 | 0;
  var fetch = function (i) {
      return function (f) {
          return Data_Maybe.fromMaybe("unexpected error")(Data_Functor.map(Data_Maybe.functorMaybe)(f)(Data_Array.index(lessons)(i)));
      };
  };
  var scoreUrl = function (i) {
      var score = fetch(i)(function (v) {
          return v.id;
      });
      return "assets/images/scores/" + (score + ".png");
  };
  var title = function (i) {
      return fetch(i)(function (v) {
          return v.title;
      });
  };
  ...
  exports["scoreUrl"] = scoreUrl;
  exports["title"] = title;
})(PS["Lessons"] = PS["Lessons"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Color = PS["Color"];                 
...
(function(exports) {
  ...
  var Pux_DOM_HTML_Attributes = PS["Pux.DOM.HTML.Attributes"];
  var Text_Smolder_Markup = PS["Text.Smolder.Markup"];        
  var taStyle = Pux_DOM_HTML_Attributes.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(CSS_Size.px(10.0))(CSS_Size.px(0.0))(CSS_Size.px(10.0))(CSS_Size.px(0.0)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.em(1.5)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.rgb(243)(246)(198)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_TextAlign.textAlign(CSS_TextAlign.leftTextAlign))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(CSS_Size.px(0.0))(CSS_Size.px(2.0))(CSS_Size.px(0.0))(CSS_Size.px(2.0)))(function () {
  ...
  var rightPaneStyle = Pux_DOM_HTML_Attributes.style(CSS_Display["float"](CSS_Display.floatLeft));
  var leftPanelComponentStyle = Pux_DOM_HTML_Attributes.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(CSS_Size.px(10.0))(CSS_Size.px(0.0))(CSS_Size.px(20.0))(CSS_Size.px(40.0)))(function () {
      return CSS_Font.fontSize(CSS_Size.em(1.2));
  }));
  var leftPaneStyle = Pux_DOM_HTML_Attributes.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(800.0)))(function () {
      return CSS_Display["float"](CSS_Display.floatLeft);
  }));
  ...
  var buttonStyle = function (enabled) {
      if (enabled) {
          return Pux_DOM_HTML_Attributes.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(10.0)))(function () {
              return CSS_Font.fontSize(CSS_Size.em(1.0));
          }));
      };
      return Pux_DOM_HTML_Attributes.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.margin(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(10.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.em(1.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color_Scheme_X11.lightgrey))(function () {
                  return CSS_Font.color(Color_Scheme_X11.darkgrey);
              });
          });
      }));
  };
  ...
  exports["leftPanelComponentStyle"] = leftPanelComponentStyle;
  exports["rightPaneStyle"] = rightPaneStyle;
  exports["taStyle"] = taStyle;
})(PS["View.CSS"] = PS["View.CSS"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Audio_SoundFont = PS["Audio.SoundFont"];
  ...
  var MoveToEnd = (function () {
      function MoveToEnd(value0) {
          this.value0 = value0;
      };
      MoveToEnd.create = function (value0) {
          return new MoveToEnd(value0);
      };
      return MoveToEnd;
  })();
  ...
  var viewParseError = function (state) {
      ...
      if (state.tuneResult instanceof Data_Either.Left) {
          ...
          return Text_Smolder_HTML.p(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup.text(state.tuneResult.value0.error + " - "))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup.text(Data_String.fromCharArray(errorPrefix)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.span)(View_CSS.errorHighlightStyle)(Text_Smolder_Markup.text(Data_String.fromCharArray(errorChar))))(function () {
  ...
  var view = function (state) {
      ...
      return Text_Smolder_HTML.div(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.h1)(View_CSS.centreStyle)(Text_Smolder_Markup.text("ABC Tutorial: Lesson " + (Data_Show.show(Data_Show.showInt)(state.lessonIndex + 1 | 0) + (" - " + Lessons.title(state.lessonIndex))))))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(View_CSS.leftPaneStyle)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(View_CSS.leftPanelComponentStyle)(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup.withEvent(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.textarea)(View_CSS.taStyle))(Text_Smolder_HTML_Attributes.cols("50")))(Text_Smolder_HTML_Attributes.rows("15")))(Text_Smolder_HTML_Attributes.value(state.abc)))(Text_Smolder_HTML_Attributes.spellcheck("false")))(Text_Smolder_HTML_Attributes.autocomplete("false")))(Text_Smolder_HTML_Attributes.autofocus("true")))(Pux_DOM_Events.onInput(function (e) {
              return new Abc(Pux_DOM_Events.targetValue(e));
          }))(Data_Monoid.mempty(Text_Smolder_Markup.monoidMarkup)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(viewParseError(state))(function () {
                  return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(View_CSS.rightPaneStyle)(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup.withEvent(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup.optionalWith(Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.button)(state.lessonIndex <= 0)(Text_Smolder_HTML_Attributes.disabled("disabled")))(View_CSS.buttonStyle(state.lessonIndex > 0)))(Text_Smolder_HTML_Attributes.className("hoverable")))(Pux_DOM_Events.onClick(Data_Function["const"](new MoveToEnd(false))))(Text_Smolder_Markup.text("first")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup.withEvent(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup.optionalWith(Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.button)(state.lessonIndex <= 0)(Text_Smolder_HTML_Attributes.disabled("disabled")))(View_CSS.buttonStyle(state.lessonIndex > 0)))(Text_Smolder_HTML_Attributes.className("hoverable")))(Pux_DOM_Events.onClick(Data_Function["const"](new Move(false))))(Text_Smolder_Markup.text("previous")))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup.withEvent(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup.optionalWith(Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.button)(state.lessonIndex >= Lessons.last)(Text_Smolder_HTML_Attributes.disabled("disabled")))(View_CSS.buttonStyle(state.lessonIndex < Lessons.last)))(Text_Smolder_HTML_Attributes.className("hoverable")))(Pux_DOM_Events.onClick(Data_Function["const"](new Move(true))))(Text_Smolder_Markup.text("next")))(function () {
                              return Text_Smolder_Markup.withEvent(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup.optionalWith(Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.button)(state.lessonIndex >= Lessons.last)(Text_Smolder_HTML_Attributes.disabled("disabled")))(View_CSS.buttonStyle(state.lessonIndex < Lessons.last)))(Text_Smolder_HTML_Attributes.className("hoverable")))(Pux_DOM_Events.onClick(Data_Function["const"](new MoveToEnd(true))))(Text_Smolder_Markup.text("last"));
                          });
                      });
                  }));
              });
          }))))(function () {
              return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(View_CSS.rightPaneStyle)(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_HTML.div(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupM)(Text_Smolder_HTML.img)(Text_Smolder_HTML_Attributes.src(Lessons.scoreUrl(state.lessonIndex)))))(function () {
                  return viewPlayer(state);
              }));
          });
      }));
  };
      ...
      return function (state) {
          ...
          if (tuneResult instanceof Data_Either.Right) {
              return {
                  ...
                  effects: [ Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(new Data_Maybe.Just(new PlayerEvent(new Data_Midi_Player.SetAbc(tuneResult.value0)))) ]
              };
          };
          if (tuneResult instanceof Data_Either.Left) {
              return Pux.noEffects((function () {
                  var $19 = {};
                  for (var $20 in newState) {
                      if ({}.hasOwnProperty.call(newState, $20)) {
                          $19[$20] = newState[$20];
                      };
                  };
                  $19.playerState = Data_Maybe.Nothing.value;
                  return $19;
              })());
          };
          throw new Error("Failed pattern match at App line 99, column 5 - line 110, column 53: " + [ tuneResult.constructor.name ]);
      };
  };
  ...
  var foldp = function (v) {
      return function (state) {
          ...
          if (v instanceof Init) {
              return onChangedAbc(state.abc)(state);
          };
          if (v instanceof Abc) {
          ...
          if (v instanceof Move) {
              var next = (function () {
                  if (v.value0) {
                      return Data_Ord.min(Data_Ord.ordInt)(state.lessonIndex + 1 | 0)(Lessons.last);
                  };
                  return Data_Ord.max(Data_Ord.ordInt)(state.lessonIndex - 1 | 0)(0);
              })();
              return onChangedAbc(Lessons.example(next))((function () {
                  var $29 = {};
                  for (var $30 in state) {
          ...
          if (v instanceof PlayerEvent) {
              if (state.playerState instanceof Data_Maybe.Just) {
                  return Pux.mapState(function (pst) {
                      ...
                      $39.playerState = new Data_Maybe.Just(pst);
                      return $39;
                  })(Pux.mapEffects(PlayerEvent.create)(Data_Midi_Player.foldp(v.value0)(state.playerState.value0)));
              };
              return Pux.noEffects(state);
          };
          throw new Error("Failed pattern match at App line 56, column 1 - line 56, column 37: " + [ v.constructor.name, state.constructor.name ]);
      };
  };
  exports["NoOp"] = NoOp;
  exports["Init"] = Init;
...
(function(exports) {
  ...
  var main = function __do() {
      var v = initialiseApp();
      var initSignal = Signal.constant(App.Init.value);
      var v1 = Pux.start({
      ...
      return Pux_Renderer_React.renderToDOM("#app")(v1.markup)(v1.input)();
  };
